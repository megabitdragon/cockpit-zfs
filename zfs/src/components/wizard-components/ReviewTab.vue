		...
		<div class="grid grid-cols-4 gap-1">
			...
			<div class="col-start-3 row-start-1 col-span-2">
				<div class="grid grid-cols-4 gap-2 justify-items-center">
					<LoadingSpinner :width="'w-40'" :height="'h-40'" :baseColor="'text-gray-200'" :fillColor="'fill-slate-500'" class="col-span-4 my-2"/>
				</div>
				<!-- <div v-if="finishPressed && creatingPool && !poolCreated" class="bg-well mt-2 mb-4 min-w-fit overflow-visible rounded-lg border border-default text-default">
...
import { LoadingSpinner } from '@45drives/cockpit-vue-components';
