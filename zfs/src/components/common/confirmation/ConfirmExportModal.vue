<template>
	<Modal :isOpen="showExportModal" @close="showExportModal = false" :marginTop="'mt-60'" :width="'w-96'" :minWidth="'min-w-96'">
        <template v-slot:title>
            <legend class="flex justify-center">Export Pool</legend>
        </template>
            ...
            <div class="w-full grid grid-rows-1">
                <div class="button-group-row mt-2 justify-between">
                    ...
                    <div class="flex flex-row">
                        <label :for="'forcefully-unmount'" class="mt-2 mr-2 block text-sm font-medium text-default">Force unmount file systems</label>
                    ...
                    <button v-if="!exporting" @click="confirmExport" :id="getIdKey('confirm-export-yes-B')" name="export-button-yes-B" class="mt-1 btn btn-primary object-right justify-end h-fit">Export</button>
...
interface ConfirmExportModalProps {
    ...
    item: string;
    name: string;
    confirmExport: ConfirmationCallback;
}
