<template>
	<div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8 overflow-auto sm:rounded-lg bg-accent rounded-md border border-default">
		...
		<div v-if="pools.length > 0 && poolsLoaded == true" class="grid grid-flow-col border border-default rounded-md">
			<div class="p-2">
				<span class="font-semibold text-lg">Pools</span>
			</div>
			<div class="p-2">
		...
		<div v-if="disks.length > 0 && disksLoaded == true" class="grid grid-flow-col border border-default rounded-md">
			<div class="p-2">
				<span class="font-semibold text-lg">Disks</span>
			</div>
			<div class="p-2">
