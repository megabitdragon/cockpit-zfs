			...
			<div class="inline-block min-w-full min-h-full align-middle rounded-md border border-default">
				<div class="overflow-y-visible ring-1 ring-black ring-opacity-5 sm:rounded-lg">
					...
					<table class="min-w-full divide-y divide-default bg-accent">
						<thead>
							<tr class="rounded-md">
								<th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-default ml-4">Name</th>
					...
					<Accordion :isOpen="false" class="divide-y divide-default bg-default ring-1 ring-black ring-opacity-5" v-for="pool, poolIdx in poolData" key="poolIdx">
						<template v-slot:title>
							<div class="grid grid-cols-7 grid-flow-cols w-full">
								<div class="whitespace-nowrap px-3 py-4 text-sm col-span-1">{{  poolData[poolIdx].name }}</div>
								<div class="whitespace-nowrap px-3 py-4 text-sm col-span-1">{{  poolData[poolIdx].status }}</div>
								<div class="whitespace-nowrap px-3 py-4 text-sm col-span-1">
								...
								<div class="whitespace-nowrap px-3 py-4 text-sm col-span-1">{{ poolData[poolIdx].properties.allocated }}</div>
								<div class="whitespace-nowrap px-3 py-4 text-sm col-span-1">{{ poolData[poolIdx].properties.free }}</div>
								<div class="whitespace-nowrap px-3 py-4 text-sm col-span-1">{{ poolData[poolIdx].properties.size }}</div>
								<div class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm col-span-1 font-medium sm:pr-6 lg:pr-8">
