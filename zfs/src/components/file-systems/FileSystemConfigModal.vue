        ...
        <template v-slot:footer>
            <div class="w-full grid grid-rows-2">
                ...
                <div class="button-group-row w-full row-start-2 justify-between mt-2">
                    ...
                    <button v-if="fileSystemsLoaded" @click="fsConfigureBtn()" :id="getIdKey('edit-fs-btn')" name="edit-fs-btn" class="mt-1 btn btn-primary object-right justify-end h-fit">Configure</button>
                    <button disabled v-if="!fileSystemsLoaded" :id="getIdKey('edit-fs-spinner')" type="button" class="btn btn-danger object-right justify-end">
